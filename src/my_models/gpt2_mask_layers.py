...
from my_models.mask_layer import MaskLayer
...
class GPT2MaskLayersLmHeadModel(GPT2LMHeadModel):
    def __init__(self, config):
        super().__init__(config)
        self.transformer = GPT2MaskLayersModel(config)


class GPT2MaskLayersModel(GPT2Model):
    def __init__(self, config):
        super().__init__(config)
        self.mask_layer = MaskLayer(
            torch.tensor(float("inf")), torch.tensor(float("-inf")), torch.tensor(0.0)
        )
